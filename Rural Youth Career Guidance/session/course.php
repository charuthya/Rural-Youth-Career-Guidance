            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="mentor.php">
                                <i class="fas fa-copy"></i>Mentor</a>
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="mentor.php">
                                <i class="fas fa-user"></i>Mentor</a>
...
<div class="container">
    ...
    <p>Unlock Your Course</p>
    <a href="new/index.html"><button class="button">Get Started</button></a>
</div>
